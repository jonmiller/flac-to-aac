...
public class RootFolder {
  ...
  public RootFolder(String path, Type type) {
    artistSubFolders = new ArrayList<>();
  ...
  public void populateChildren() throws NonExistenceException, MetaDataFileException {
    if (exists) {
      ...
      throw new NonExistenceException("Attempted to call populateChildren " + "on a RootFolder " +
          "that does not exist");
    }
  }

  public void populateChild(String artist,
                            String album) throws NonExistenceException, MetaDataFileException {
    if (exists) {
      ...
      throw new NonExistenceException("Attempted to call populateChild " + "on a RootFolder that " +
          "does not exist");
    }
  }

  public void copyStructureTo(
      RootFolder destinationRootFolder) throws NonExistenceException, MetaDataFileException,
    ...
    if (exists) {
      ...
      throw new NonExistenceException("Attempted to call copyStructureTo " + "on a RootFolder " +
          "that does not exist");
    }
  }

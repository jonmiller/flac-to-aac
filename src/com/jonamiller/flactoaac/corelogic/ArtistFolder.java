...
public class ArtistFolder {
  ...
  void populateChildren() throws NonExistenceException, MetaDataFileException {
    if (exists) {
      ...
      throw new NonExistenceException("Attempted to call populateChildren " + "on an ArtistFolder" +
          " that does not exist");
    }
  }
  ...
  void populateChild(String album) throws NonExistenceException, MetaDataFileException {
    if (exists && file.exists()) {
      ...
      throw new NonExistenceException("Attempted to call populateChild " + "on a AlbumFolder that" +
          " does not exist");
    }
  }

  void copyStructureTo(
      ArtistFolder destinationArtistFolder) throws NonExistenceException, MetaDataFileException,
